...
path      = '//Rijnh/Shares/Projects/Pilot/Measurement Data/IR Camera/2014/2014-04/2014-04-23/'
;path      = unix_or_win('//Rijnh/Shares/Projects/Pilot/Measurement Data/IR Camera/2014/2014-04/2014-04-16/')
file      = 'W0004.SEQ'
fname     = path+file
...
cgplot,ir_time,ir_temp,/add
cgplot,ir_time,ir_temp2,/over,/add,col='red',line = 2
...
cgplot,ir_time,ir_prof_h,/add
cgplot,ir_time,ir_prof_h2,/over,/add,col='red',line = 2

cg_newwindow, tit = 'Vertical T (C) at max frame'
cgplot,ir_time,ir_prof_v,/add
cgplot,ir_time,ir_prof_v2,/over,/add,col='red',line = 2
